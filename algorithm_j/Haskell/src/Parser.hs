...
happyExpList = Happy_Data_Array.listArray (0,32) ([336,2,43012,4096,0,32,0,10754,1344,0,40983,2,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","Exp","let","in","lambda","arrows","var","'='","'('","')'","%eof"]
        bit_start = st * 13
        bit_end = (st + 1) * 13
...
action_14 (4) = happyGoto action_7
...
happyError' :: () => ([(TokenClass)], [String]) -> HappyIdentity a
